...
export class BoredApeYachtClub extends ethereum.SmartContract {
  ...
  getmintCount(): BigInt {
    let result = super.call("getmintCount", "getmintCount():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getmintCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getmintCount", "getmintCount():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  mintCount(param0: Address): BigInt {
    let result = super.call("mintCount", "mintCount(address):(uint256)", [
  ...
  try_mintCount(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mintCount", "mintCount(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
